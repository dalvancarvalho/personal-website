...
export default function Link({ icon, href, label }) {
  ...
  return (
    <a
      ...
      hover:bg-blue-400/25        focus-visible:bg-blue-400/25
      hover:dark:bg-orange-500/25 focus-visible:dark:bg-orange-500/25
      hover:text-slate-800        focus-visible:text-slate-800
      hover:dark:text-gray-200    focus-visible:dark:text-gray-200"
      href={href}
