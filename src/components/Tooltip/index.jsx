...
function Tooltip(props) {
  ...
  return (
    <p
      ...
      dark:border-t-dark-1 rounded-[0.5em] shadow-md opacity-0 border-b-transparent
      border-x-transparent bg-slate-50 dark:bg-dark-2 text-slate-500 dark:text-gray-300
