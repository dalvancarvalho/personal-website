...
function CodeSnippet(props) {
  ...
  return (
    <div className="relative m-auto my-12 w-full md:w-5/6 bg-slate-150 dark:bg-dark-3 rounded-md shadow-md overflow-hidden transition-[background-color] duration-300 ">
